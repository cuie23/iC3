...
int main(int argc, char* argv[]) {
  ...
  std::string c3_proj_filename = 
      "examples/resources/multifinger_hand/ic3_debug_data/all_delta_projections_180_thresh.bin";
  ...
  std::string z_sol_filename = 
      "examples/resources/multifinger_hand/ic3_debug_data/all_z_sols_180_thresh.bin";
  ...
  std::string z_sol_rollout_filename = 
      "examples/resources/multifinger_hand/ic3_debug_data/rollout_z_sol_180_thresh.bin";
  vector<MatrixXd> z_sol_rollout =
      c3::utils::LoadTrajectoryData<vector<MatrixXd>>(
          z_sol_rollout_filename);

  std::string gamma_filename = 
      "examples/resources/multifinger_hand/ic3_debug_data/gammas_180_thresh.bin";
  vector<MatrixXd> gamma =
      c3::utils::LoadTrajectoryData<vector<MatrixXd>>(
          gamma_filename);

  std::string in_contact_filename = 
      "examples/resources/multifinger_hand/ic3_debug_data/in_contact_180_thresh.bin";
  ...
  std::string c3_proj_csv_filename = 
      "examples/resources/multifinger_hand/ic3_debug_data/csv/delta_projections_180_thresh.csv";
  ...
  std::string z_sol_csv_filename = 
      "examples/resources/multifinger_hand/ic3_debug_data/csv/z_sol_180_thresh.csv";
  ...
  std::string rollout_csv_filename = 
      "examples/resources/multifinger_hand/ic3_debug_data/csv/rollout_180_thresh.csv";
  std::ofstream outfile_rollout(rollout_csv_filename);

  std::string gamma_csv_filename = 
      "examples/resources/multifinger_hand/ic3_debug_data/csv/gammas_180_thresh.csv";
  std::ofstream outfile_gamma(gamma_csv_filename);

  std::string in_contact_csv_filename = 
      "examples/resources/multifinger_hand/ic3_debug_data/csv/in_contact_180_thresh.csv";
