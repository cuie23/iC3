...
private:
  ...
  tuple<MatrixXd, MatrixXd, MatrixXd, MatrixXd, MatrixXd> DoC3Rollout(VectorXd x0, MatrixXd x_hat, MatrixXd u_hat, VectorXd xd, VectorXd ud, 
  ...
  // Given a reference trajectory x_hat, u_hat, lambda_hat, runs fixed-mode mpc                                            
