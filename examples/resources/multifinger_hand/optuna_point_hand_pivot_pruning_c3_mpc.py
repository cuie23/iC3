...
def log_best_callback(study, trial):
    ...
    if trial.value < 15:
        ...
        with open("examples/resources/multifinger_hand/optuna_point_hand_pivot/sub_15_trials_pivot_c3_mpc.txt", "a") as f:
...
# python3 examples/resources/multifinger_hand/optuna_point_hand_pivot_pruning_c3_mpc.py
