...
# ======================================================================
    ...
    # num_iters = trial.suggest_categorical("num_iters", [3, 5])
    num_iters = 1
...
def log_best_callback(study, trial):
    ...
    if trial.value < 15:
        ...
        with open("examples/resources/multifinger_hand/optuna_point_hand_180/sub_15_trials_180_c3_mpc.txt", "a") as f:
    ...
    if study.best_trial.number == trial.number:
        ...
        with open("examples/resources/multifinger_hand/optuna_point_hand_180/best_params_180_c3_mpc.txt", "w") as f:
            f.write("=========================================\n")
...
# python3 examples/resources/multifinger_hand/optuna_point_hand_180_pruning_c3_mpc.py
if __name__ == "__main__":

    print(platform.release().lower())
    if "microsoft" in platform.release().lower():
        STORAGE_URL = "sqlite:////home/ttesc255/optuna_data/optuna_results_180_c3_mpc.db"
    else:
      STORAGE_URL = "sqlite:///examples/resources/multifinger_hand/optuna_point_hand_180/optuna_results_180_c3_mpc.db"
    ...
    study = optuna.create_study(
        study_name="MSiC3_point_hand_180_c3_mpc",
        storage=storage,
        load_if_exists=True, 
        sampler=sampler, 
        direction="minimize")
