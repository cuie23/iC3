...
# python3 examples/resources/multifinger_hand/obj_to_sdf.py

if __name__ == "__main__":
    import sys
    if len(sys.argv) < 2:
        obj_path = "examples/resources/multifinger_hand/urdf/comfree_objects/rubber_duck.obj"
        out_dir = "examples/resources/multifinger_hand/urdf/comfree_objects/rubber_duck.sdf"
    else:
        obj_path = sys.argv[1]
