...
STORAGE_PATH = "sqlite:///examples/resources/multifinger_hand/optuna_point_hand_pivot_parallel/optuna_results_pivot_parallel.db"
...
q_vector[15] = cube_position_weight
...
ic3_options["warm_start_alpha"] = 0
...
# python3 examples/resources/multifinger_hand/write_yaml_optuna_point_hand_pivot_parallel.py