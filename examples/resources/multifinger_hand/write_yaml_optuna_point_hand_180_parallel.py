...
STORAGE_PATH = "sqlite:///examples/resources/multifinger_hand/optuna_point_hand_180_parallel/optuna_results_180_parallel.db"
...
# python3 examples/resources/multifinger_hand/write_yaml_optuna_point_hand_180_parallel.py