...
# python3 examples/resources/multifinger_hand/obj_to_sdf_lcs.py

if __name__ == "__main__":
    if len(sys.argv) < 2:
        obj_path = "examples/resources/multifinger_hand/urdf/comfree_objects/stick.obj"
        out_dir = "examples/resources/multifinger_hand/urdf/comfree_objects/stick/stick_lcs.sdf"
    else:
        obj_path = sys.argv[1]
        out_dir = sys.argv[2] if len(sys.argv) > 2 else None

    make_sdf(obj_path, out_dir)
