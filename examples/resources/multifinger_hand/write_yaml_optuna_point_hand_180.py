...
c3_options["c3_options"]["gamma_threshold"] = flow_seq([gamma_threshold / 100.0] * (n_contacts))
c3_options["c3_options"]["phi_threshold"] = flow_seq([phi_threshold / 100.0] * (n_contacts))
...
ic3_options["alpha_object_step"] = (100 - alpha_object_real) / (num_iters - 1)
...
# python3 examples/resources/multifinger_hand/write_yaml_optuna_point_hand_180.py